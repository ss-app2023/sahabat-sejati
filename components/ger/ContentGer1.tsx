    ...
    <section id="ContentGer1" className="dark:bg-gray-900">
      ...
      <div className="gap-16 items-center px-10 py-8 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-10 lg:px-6">
        <div className="grid grid-cols-2 gap-4 mt-8 mb-4 sm:mb-10">
          <Image className="w-full rounded-lg shadow-slate-800 shadow-md" src={officeLong1} alt="office content 1" />
          <Image className="mt-4 w-full lg:mt-10 rounded-lg shadow-slate-800 shadow-md" src={officeLong2} alt="office content 2" />
        </div>
      ...
      <div className="px-10 py-8 mx-auto max-w-screen-xl lg:py-10 lg:px-6">
        ...
        <video className="w-full rounded-xl mb-6 xs:mb-2 shadow-slate-600 shadow-md" controls>
          <source width={100} height={100} src="http://jerman.mitragroup.id/wp-content/uploads/2022/08/Hotel-Occur-Wm-1.m4v" type="video/mp4" />
      ...
      <div className="px-10 py-8 mx-auto max-w-screen-xl lg:py-10 lg:px-6">
        <video className="w-full rounded-xl mb-6 shadow-slate-600 shadow-md" controls>
          <source width={100} height={100} src="http://jerman.mitragroup.id/wp-content/uploads/2023/02/Lia-Amelia-Sari-MSA-Education.mp4" type="video/mp4" />
          Your browser does not support the video tag.
        </video>
      ...
      <div className="grid md:grid-cols-3 sm:grid-cols-1 md:gap-2 px-10 py-8 mx-auto max-w-screen-xl lg:py-10 lg:px-6">
        <div className="px-10 py-8 mx-auto max-w-screen-xl lg:py-10 lg:px-6">
          <video className="w-full rounded-xl mb-6 shadow-slate-300 shadow-md" controls>
            <source width={100} height={100} src="https://jerman.mitragroup.id/wp-content/uploads/2023/02/WhatsApp-Video-2023-02-16-at-15.17.56.mp4" type="video/mp4" />
            Your browser does not support the video tag.
          </video>
        ...
        <div className="px-10 py-8 mx-auto max-w-screen-xl lg:py-10 lg:px-6">
          <video className="w-full rounded-xl mb-6 shadow-slate-300 shadow-md" controls>
            <source width={100} height={100} src="https://jerman.mitragroup.id/wp-content/uploads/2023/02/VID-20230220-WA0016.mp4" type="video/mp4" />
            Your browser does not support the video tag.
          </video>
        ...
        <div className="px-10 py-8 mx-auto max-w-screen-xl lg:py-10 lg:px-6">
          <video className="w-full rounded-xl mb-6 shadow-slate-300 shadow-md" controls>
            <source width={100} height={100} src="http://jerman.mitragroup.id/wp-content/uploads/2022/08/Preview-Jerman-WM.mp4" type="video/mp4" />
            Your browser does not support the video tag.
          </video>
        ...
        <div className="py-6 dark:bg-gray-800 dark:text-gray-50">
          <div className="container grid grid-cols-2 gap-4 p-4 mx-auto md:grid-cols-4">
            <Image
              src={photoGer5}
              alt="Photo Germany 5"
              className="w-auto h-auto object-none object-center shadow-slate-300 shadow-lg col-span-2 row-span-2 rounded-2xl min-h-96 md:col-start-3 md:row-start-1 dark:bg-gray-500 aspect-square"
            />
            <Image alt="Photo Germany 1" className="w-full h-full rounded-2xl shadow-slate-300 shadow-lg min-h-48 dark:bg-gray-500 aspect-square" src={photoGer1} />
            <Image alt="Photo Germany 2" className="w-full h-full rounded-2xl shadow-slate-300 shadow-lg min-h-48 dark:bg-gray-500 aspect-square" src={photoGer2} />
            <Image alt="Photo Germany 3" className="w-full h-full rounded-2xl shadow-slate-300 shadow-lg min-h-48 dark:bg-gray-500 aspect-square" src={photoGer3} />
            <Image alt="Photo Germany 4" className="w-full h-full rounded-2xl shadow-slate-300 shadow-lg min-h-48 dark:bg-gray-500 aspect-square" src={photoGer4} />
          </div>
        </div>
      </div>
    </section>
