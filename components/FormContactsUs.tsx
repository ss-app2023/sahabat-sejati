    ...
    <section className="text-gray-600 body-font relative">
      <div className="container px-5 py-24 mx-auto flex md:flex-nowrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden md:mr-6 lg:mr-10 p-10 flex items-end justify-start relative">
          ...
          <div className="bg-white relative flex flex-wrap sm:py-8 sm:px-6 rounded shadow-md">
            ...
            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
              ...
              <a className="text-blue-500 text-base leading-relaxed">info@sahabatsejati.info</a>
        ...
        <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
          <h2 className="text-gray-900 text-lg mb-1 font-medium title-font">Form Contact Us</h2>
          <p className="leading-relaxed mb-5 text-gray-600">Jika anda memiliki pertanyaan, anda bisa menayakannya di form di bawah ini. Terima Kasih.</p>
          ...
          <div className="relative mb-4">
            <label htmlFor="telephone" className="leading-7 text-sm text-gray-600">
              Telephone
            </label>
            <input
              type="telephone"
          ...
          <p className="text-base font-normal text-gray-500 mt-3">Jika anda sudah mengirim pertanyaan, jika belum ada respon anda bisa langsung menghubungi nomor dibawah ini.</p>
